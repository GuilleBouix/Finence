...
type FuncionAgregarMovimiento = (tipo: 'ingresos' | 'gastos', monto: string, descripcion: string) => Promise<boolean>;


// Componente de formulario para agregar nuevas transacciones
export const TransactionForm = ({ onAdd, cargando }: { onAdd: FuncionAgregarMovimiento, cargando: boolean }) => {
