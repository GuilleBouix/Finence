...
export default function EditTransactionModal({ transaction, userId, onClose }: EditTransactionModalProps) {
            ...
            <div className="bg-[#111] border border-[#222] p-6 rounded-2xl max-w-md w-full shadow-2xl space-y-4">
                <div className="flex justify-between items-center">
                  <div className='flex items-center gap-2'>
                    ...
                    <span className={`text-[10px] px-2 py-1 rounded border font-bold uppercase ${transaction.tipo === 'ingresos' ? 'border-green-500/20 text-green-500' : 'border-red-500/20 text-red-500'}`}>
                        {transaction.tipo}
                    </span>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        <label className="text-[10px] text-gray-500 uppercase font-bold tracking-widest">Descripción</label>
                    ...
                    <div className="space-y-1">
                        <label className="text-[10px] text-gray-500 uppercase font-bold tracking-widest">Monto ($)</label>
