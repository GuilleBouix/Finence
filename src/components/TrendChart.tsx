...
export const TrendChart = ({ ingresos, gastos }: TrendChartProps) => {
  ...
  // Memoizamos el procesamiento de datos para el gráfico
  const datosGrafico = useMemo(() => {
    ...
    // Agrupamos los movimientos por fecha
  ...
  // Verificamos si hay datos para mostrar el gráfico
  ...
  return (
    <div className="bg-[#111] p-4 rounded-xl border border-[#222] flex flex-col h-75">
      ...
      <div className="flex justify-between items-center mb-4 h-8">
        ...
        {tieneDatos && (
          <div className="flex bg-[#0a0a0a] p-1 rounded-lg border border-[#222] animate-fade">
            <button
      ...
      {/* Contenedor dinámico: Gráfico o Mensaje Vacío */}
        ...
        {!tieneDatos ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={datosGrafico}>
              {/* Definiciones de gradientes para el área del gráfico */}
              <defs>
