...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-4 font-sans antialiased">
            <div className="w-full max-w-85 bg-[#111] border border-[#222] p-6 rounded-2xl shadow-2xl
            animate-fade-in">
                {/* Encabezado del formulario de login */}
                <div className="text-center mb-6
                animate-fade-down">
                    <h2 className="text-2xl font-bold tracking-tight">Bienvenido</h2>
                    <p className="text-xs text-gray-500 uppercase mt-1">Ingresa a tu cuenta</p>
                </div>
                ...
                <form onSubmit={manejarLogin} className="flex flex-col gap-3">
                    ...
                    {mensaje.texto && (
                        <div className={`text-xs p-2 rounded-lg border animate-fade ${mensaje.tipo === 'error' ? 'bg-red-500/10 border-red-500/20 text-red-500' : 'bg-[#22c55e]/10 border-[#22c55e]/20 text-[#22c55e]'}`}>
                            {mensaje.texto}
                        </div>
                    )}
                    ...
                    <div className="relative group animate-fade-down animate-delay-50">
                        <LuMail className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-[#22c55e] transition-colors" size={14} />
                        <input
                    ...
                    <div className="relative group animate-fade-down animate-delay-100">
                        <LuLock className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-[#22c55e] transition-colors" size={14} />
                        <input
                            className="w-full bg-[#0a0a0a] border border-[#222] py-2.5 pl-9 pr-3 rounded outline-none focus:border-[#22c55e]/50 text-sm transition-all"
                            type="password"
